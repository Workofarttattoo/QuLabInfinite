...
class EcologyLab:
    ...
    def habitat_fragmentation_analysis(self,
        ...
        if n_patches == 0:
            ...
            patch_sizes = patch_sizes_arr.astype(float)
            ...
            patch_perimeters = patch_perimeters_arr[1:].astype(float)
        ...
        if len(patch_sizes) > 0:
            ...
            shape_indices = np.ones_like(patch_sizes)
        ...
        if n_patches > 1:
            if n_patches < 50:
                # Fallback to pure python loop for small datasets
                centroids = []
                ...
                # Vectorized center of mass and cKDTree for large datasets
                ...
                # query_pairs is <=, use threshold - 1e-9 to simulate <
