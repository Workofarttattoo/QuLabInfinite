...
class ComputerVisionLab:
    ...
    def convolution2d(self, image: np.ndarray, kernel: np.ndarray,
        ...
        kh, kw = kernel.shape
        # Create virtual sliding windows
        ...
        return np.tensordot(strided_windows, kernel, axes=((2, 3), (0, 1)))
    ...
    def max_pooling2d(self, image: np.ndarray, pool_size: int = 2,
        ...
        # Apply stride
        strided_windows = windows[::stride, ::stride]
        # Max over the window dimensions
        return strided_windows.max(axis=(2, 3))
    ...
    def average_pooling2d(self, image: np.ndarray, pool_size: int = 2,
        ...
        # Apply stride
        strided_windows = windows[::stride, ::stride]
        # Mean over the window dimensions
        return strided_windows.mean(axis=(2, 3))
