...
## 2026-04-26 - Keyboard Accessibility for Custom Inputs
**Learning:** When using contenteditable on non-input elements, they require explicit tabindex="0" and :focus-visible outlines to be keyboard accessible.
**Action:** Always add tabindex and focus styles to custom interactive elements.
