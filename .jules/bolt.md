...
## 2025-06-27 - Coordinate Descent Optimization
**Learning:** Recomputing residuals from scratch for each feature inside coordinate descent algorithms like LASSO is extremely inefficient (O(N*F)).
**Action:** Precompute the initial residual and maintain it incrementally by adding/subtracting the effect of the updated feature. Precompute feature norms outside the loop to avoid repeated vector multiplications.
