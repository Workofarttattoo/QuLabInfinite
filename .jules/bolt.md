...
## 2025-03-05 - Vectorize Sliding Window Operations
**Learning:** Explicit Python nested loops over NumPy arrays for convolutions and pooling operations create massive bottlenecks due to loop overhead.
**Action:** Utilize `np.lib.stride_tricks.sliding_window_view` combined with vectorized operations like `np.tensordot` or axis aggregations to keep processing strictly in C, improving performance dramatically.
