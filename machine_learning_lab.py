...
class MachineLearningLab:
    ...
    def polynomial_features(self, X: np.ndarray, degree: int = 2) -> np.ndarray:
        ...
        for d in range(1, degree + 1):
            # ⚡ BOLT: Replace slow recursive generator with itertools and numpy column slicing
            # This avoids O(n^d) call-stack overhead and provides massive speedups for large dimensions
