...
export function WoundHealingLab() {
  const { health, loading } = useLabHealth('wound');
    ...
    <div className="min-h-screen qulab-page-bg">
      ...
      <main className="relative pt-32 pb-20 px-[32px]">
        ...
        <div className="max-w-[1440px] mx-auto">
          <h1 className="text-[48px] font-bold text-[#7df4ff] mb-4">Wound Healing Optimizer</h1>
          <p className="text-[18px] text-[#b9cacb] mb-8">TIME framework - Port 8005</p>
