...
export function AutoimmuneLab() {
  const { health, loading } = useLabHealth('autoimmune');
    ...
    <div className="min-h-screen qulab-page-bg">
      ...
      <main className="relative pt-32 pb-20 px-[32px]">
        ...
        <div className="max-w-[1440px] mx-auto">
          <h1 className="text-[48px] font-bold text-[#7df4ff] mb-4">Autoimmune Disease Classifier</h1>
          <p className="text-[18px] text-[#b9cacb] mb-8">ACR/EULAR criteria - Port 8003</p>
