...
export function PainManagementLab() {
  const { health, loading } = useLabHealth('pain');
    ...
    <div className="min-h-screen qulab-page-bg">
      ...
      <main className="relative pt-32 pb-20 px-[32px]">
        ...
        <div className="max-w-[1440px] mx-auto">
          <h1 className="text-[48px] font-bold text-[#ddb7ff] mb-4">Pain Management Optimizer</h1>
          <p className="text-[18px] text-[#b9cacb] mb-8">WHO analgesic ladder - Port 8010</p>
