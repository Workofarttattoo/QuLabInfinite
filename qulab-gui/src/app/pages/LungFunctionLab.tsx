...
export function LungFunctionLab() {
  const { health, loading } = useLabHealth('lung');
    ...
    <div className="min-h-screen qulab-page-bg">
      ...
      <main className="relative pt-32 pb-20 px-[32px]">
        ...
        <div className="max-w-[1440px] mx-auto">
          <h1 className="text-[48px] font-bold text-[#7df4ff] mb-4">Lung Function Analyzer</h1>
          <p className="text-[18px] text-[#b9cacb] mb-8">GLI-2012 reference equations - Port 8009</p>
