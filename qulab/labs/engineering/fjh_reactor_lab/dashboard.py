...
def build_dashboard(
    ...
    dashboard = {
        ...
        "HARDWARE": {
            ...
            "igbt": config.igbt.to_dict(),
            "side_electrolytic_bank": config.side_electrolytic_bank.to_dict(),
            "uses_nonflash_electrolytic_dump": config.uses_nonflash_electrolytic_dump,
